...
namespace RTSEngine
{
    public class NPCResourceCollector : NPCComponent
    {
        ...
        {
            //Remove it and find alternative
        ...
        public void RemoveResource(Resource resource, bool findAlternative)
        {
            ...
            if (InResourcesToCollect(resource))
            {
                ...
                if(findAlternative) //if we're supposed to find an alternative resource
