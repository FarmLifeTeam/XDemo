...
namespace RTSEngine
{
	public class UnitManager : MonoBehaviour {
        ...
        public Unit CreateUnit(Unit unitPrefab, Vector3 spawnPosition, Quaternion spawnRotation, Vector3 gotoPosition, int factionID, Building createdBy, bool free = false, bool updatePopluation = false)
        {
        ...
        public Unit CreateUnitLocal (Unit unitPrefab, Vector3 spawnPosition, Quaternion spawnRotation, Vector3 gotoPosition, int factionID, Building createdBy, bool free = false, bool updatePopulation = true)
        {
            ...
            newUnit.SetInitialTargetPosition(createdBy, gotoPosition); //set creator building and make unity move to its goto position
